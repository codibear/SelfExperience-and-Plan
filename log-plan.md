...
# 开发安排
- 14-16：
  - ~~修复bug1（首页白板）~~  `a)4.14 		已经修复`  
  - ~~完成put方法的获取，并把post get put方法封装~~，并在listview调出   `a)4.14		完成put方法获取` 
...
- 21-24：
  - 完成状态1（定位完全实现）  
  - ~~修复bug2（即完成状态4页面的存储）解决fragment页面的存储~~ `4.14 完成fragment的界面存储的修改`  

- 25：  
  -完成android端向服务器提交时间数据功能     
